...
25년 10월달 관심 가는 회사들에서 낸 논문. 특히 재밌게 본 회사들은 주석을 달았다.
...
아마존은 구글과 비슷하게 서비스 경험 개선 방향의 연구들이 이번에 발표되었다. 구글은 gemini를 포함한 직접적인 서비스를 고려한 것 같고 아마존은 클라우드에서 제공하는 LLM 관련 서비스가 이유가 아닐까 싶다.
